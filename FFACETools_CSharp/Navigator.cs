...
namespace FFACETools
{
    public partial class FFACE
    {
        ...
        public class NavigatorTools
        {
            ...
            /// <param name="ID">ID of the NPC</param>
            /// <param name="timeOut">Time out in milliseconds</param>
            public bool GotoNPC (int ID, int timeOut)
            {
                return Goto(() => _FFACE.NPC.PosX(ID), () => _FFACE.NPC.PosY(ID), () => _FFACE.NPC.PosZ(ID), false, timeOut);
            ...
            public bool Goto(float X, float Z, bool KeepRunning)
            {
                return Goto(() => X, () => _FFACE.Player.PosY, () => Z, KeepRunning, -1);
            }
            ...
            /// <param name="KeepRunning">Whether to keep moving after reaching the destination</param>
            /// <param name="timeOut">Time out in milliseconds</param>
            public bool Goto(float X, float Z, bool KeepRunning, int timeOut)
            {
                return Goto(() => X, () => _FFACE.Player.PosY, () => Z, KeepRunning, timeOut);
            }
            ...
            /// <param name="z">Z coordinate of the destination (will not live update as it runs)</param>
            /// <param name="KeepRunning">Whether to keep moving after reaching the destination</param>
            public bool Goto(float X, float Y, float Z, bool KeepRunning)
            {
                return Goto(() => X, () => Y, () => Z, KeepRunning, -1);
            }
            ...
            /// <param name="KeepRunning">Whether to keep moving after reaching the destination</param>
            /// <param name="timeOut">Time out in milliseconds</param>
            public bool Goto(float X, float Y, float Z, bool KeepRunning, int timeOut)
            {
                return Goto(() => X, () => Y, () => Z, KeepRunning, timeOut);
            }
            ...
            /// <param name="KeepRunning">Whether to keep moving after reaching the destination</param>
            public bool Goto(Position position, bool KeepRunning)
            {
                return Goto(() => position.X, () => position.Y, () => position.Z, KeepRunning, -1);
            }
            ...
            /// <param name="KeepRunning">Whether to keep moving after reaching the destination</param>
            /// <param name="timeOut">Time out in milliseconds</param>
            public bool Goto(Position position, bool KeepRunning, int timeOut)
            {
                return Goto(() => position.X, () => position.Y, () => position.Z, KeepRunning, timeOut);
            }
            ...
            /// <param name="KeepRunning">Whether to keep moving after reaching the destination</param>
            public bool Goto(dPoint x, dPoint z, bool KeepRunning)
            {
                return Goto(x, () => _FFACE.Player.PosY, z, KeepRunning, -1);
            ...
            /// <param name="KeepRunning">Whether to keep moving after reaching the destination</param>
            /// <param name="timeOut">Time out in milliseconds</param>
            public bool Goto(dPoint x, dPoint z, bool KeepRunning, int timeOut)
            {
                return Goto(x, () => _FFACE.Player.PosY, z, KeepRunning, timeOut);
            ...
            /// <param name="z">Function returning Z coordinate of the destination</param>
            /// <param name="KeepRunning">Whether to keep moving after reaching the destination</param>
            public bool Goto(dPoint x, dPoint y, dPoint z, bool KeepRunning)
            {
                return Goto(x, y, z, KeepRunning, -1);
            ...
            /// <param name="KeepRunning">Whether to keep moving after reaching the destination</param>
            /// <param name="timeOut">Time out in milliseconds</param>
            public bool Goto (dPoint x, dPoint y, dPoint z, bool KeepRunning, int timeOut)
            {
                float X = x();
                float Y = y();
                float Z = z();
            ...
            public float HeadingTo(double oriX, double oriZ, double destX, double destZ, HeadingType headingType)
            {
                destX = destX - oriX;
                destZ = destZ - oriZ;
                double H = -Math.Atan2(destZ, destX);
                if (headingType == HeadingType.Degrees)
                {
                    H = PosHToDegrees((float)H);
                }
